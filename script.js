...
(function() {
    emailjs.init("SVZhsXqPZTnhstpl8");  // Replace "user_xxx" with your EmailJS user ID= JqG3qkYOmgxuLj1Yn
})();
...
document.querySelector('.contact_form').addEventListener('submit', function(event) {
    ...
    const serviceID = "service_t5aku8p";
    const templateID = "template_235auys";
